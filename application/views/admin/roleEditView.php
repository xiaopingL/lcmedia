         ...
         <form class="form-horizontal form_validation_ttip" action="" method="post">
             <fieldset>
                 <div class="control-group formSep">
                     ...
                     <input type="text" name="roleName" class="input-xlarge" value="<?php echo $roleName; ?>" />
                     </div>
                 </div>
				<div class="control-group">
			     ...
			     <div class="control-group">
			          <div class="controls"><button class="btn btn-gebo" type="submit" name="submitCreate" value="修改">修改角色</button></div>
			     </div>
		    </fieldset>
		</form>
	</div>
