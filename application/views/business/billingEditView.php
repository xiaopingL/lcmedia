...
<form action="" method="post" id="mainform" name="mainform" class="form_validation_ttip" novalidate="novalidate">
    <table class="table table-bordered table-striped" id="smpl_tbl">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <select name="class" id="class" style="width:100px">
                           ...
                           <option value="<?php echo $key;?>" <?php echo $class==$key?'selected':'';?>><?php echo $val;?></option>
                           <?php } ?>
                    </select>
                </td>
                <td><b>发票性质</b></td>
            ...
            <tr>
                ...
                <td>
                    <select name="ourCompany" id="ourCompany" style="width:100px">
                           ...
                           <option value="<?php echo $key;?>" <?php echo $ourCompany==$key?'selected':'';?>><?php echo $val;?></option>
                           <?php } ?>
                    </select>
                </td>
                <td><b>发票类型</b></td>
                <td>
                    <select name="cate" id="cate" style="width:100px">
                           ...
                           <option value="<?php echo $key;?>" <?php echo $cate==$key?'selected':'';?>><?php echo $val;?></option>
                           <?php } ?>
                    </select>
                    <span id="other" style="display:<?php echo $cate==3?'':'none'?>">&nbsp;备注：<input type="text" name="cate_other" id="cate_other" style="width:80px" value="<?php echo $cate_other;?>"></span>
                </td>
            </tr>
            ...
            <tr>
                <td><b>备注</b></td>
                <td colspan="3"><textarea name="remark" id="remark" class="span3"><?php echo $remark;?></textarea></td>
            </tr>
