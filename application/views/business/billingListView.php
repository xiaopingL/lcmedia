...
<div class="well well_classmar">
    ...
    <table class="table table-condensed">
        ...
        <tbody>
            ...
            <tr class="rowlink">
                ...
                <td>
                    <a href="<?php echo site_url('/business/BillingController/billingDetail/'.$value['billingId']);?>" title="查看"><i class="icon-eye-open"></i></a>&nbsp;&nbsp;
                    <?php if($value['flow'][0]['isOver'] == 0){?>
                    <a href="<?php echo site_url('/business/BillingController/billingEdit/'.$value['billingId']); ?>" title="修改"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
	                <a href="javascript:deleteConFirm('<?php echo site_url('business/BillingController/billingDel/'.$value['billingId']); ?>')" title="删除"><i class="icon-trash"></i></a>
	                <?php } ?>
                </td>
            </tr>
                <?php endforeach;?>
    ...
    <div>
        ...
        <font color="red">开票总金额：<?php echo $getMoney['totalMoney']?>(元)</font>
        <?php }?>
    </div>
</div>
