    ...
    <table class="table table-bordered table-striped" id="smpl_tbl">
        <tbody>
            <tr>
                ...
                <td colspan="3" style="color:green"><?php echo $client['name'];?></td>
            </tr>
            ...
            <tr>
                <td><b>上刊时间</b></td>
                <td><input type="text" name="issueDate" id="issueDate" value="" onClick="WdatePicker()"></td>
                <td><b>下刊时间</b></td>
                <td><input type="text" name="underDate" id="underDate" value="" onClick="WdatePicker()"></td>
            </tr>
            ...
            <tr>
                ...
                <td><b>营销费用</b></td>
                <td><input type="text" name="market" id="market" value="" class="span1">&nbsp;<font color=red>（元）</font>
                                                    备注：<input type="text" name="markeyNote" id="markeyNote" value="" class="span2">
                </td>
            </tr>
                ...
                <td colspan="3">
                    <table id="tbl_info" cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#bdebff">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><input type="text" name="remark[]" class="span4"></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
             ...
             <tr>
                <td><b>备注说明</b></td>
                <td colspan="3">
                    <textarea name="description" class="span4"></textarea>
		        </td>
            </tr>
