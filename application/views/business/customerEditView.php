    ...
    <table class="table table-bordered table-striped" id="smpl_tbl">
        <tbody>
                ...
                <td style="vertical-align: middle;">
                    <select name="level" id="level" style="width:100px;">
                     <?php foreach ($customer['Level'] as $key => $value):?>
                        <option value="<?php echo $key?>" <?php echo $detail['level']==$key?'selected':'';?>><?php echo $value?></option>
                     <?php endforeach;?>
                   </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">
                    ...
                    <?php foreach ($customer['Source'] as $key => $value):?>
                        <option value="<?php echo $key?>" <?php echo $detail['source']==$key?'selected':'';?>><?php echo $value?></option>
                        <?php endforeach;?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;"><input type="text" name="name" id="name" value="<?php echo $detail['name']?>"></td>
            </tr>

            <tr>
                <td style="vertical-align: middle;text-align:center;font-weight: bold;">公司名称</td>
                <td style="vertical-align: middle;"><input type="text" name="proname" id="proname" value="<?php echo $detail['proname']?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">
                    ...
                    <?php foreach ($customer['industry'] as $key => $value):?>
                        <option value="<?php echo $key?>" <?php echo $key==$detail['industry']?'selected':'';?>><?php echo $value?></option>
                        <?php endforeach;?>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;"><input type="text" name="address" id="address" value="<?php echo $detail['address']?>" class="span3"></td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;"><input type="text" name="clientPhone" id="clientPhone" value="<?php echo $detail['phone']?>"></td>
            </tr>
