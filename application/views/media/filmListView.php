...
<form method="post" action="">
    <thead>
        <tr>
          ...
          <th>&nbsp;<a href="<?php echo site_url("media/FilmController/filmAdd")?>">新增信息</a></th>
        </tr>
    </thead>
</form>
</table>
    ...
    <table class="table table-condensed">
        ...
        <tbody>
            ...
            <tr class="rowlink">
                ...
                <td><?php echo $advert['position'][$value['position']];?></td>
                <td><?php echo $advert['pay_type'][$value['pay_type']];?></td>
                <td><?php echo $value['issue']?str_replace(' ','年',$value['issue']).'月':''; ?></td>
                ...
                <td>
                    <a href="<?php echo site_url('/media/FilmController/filmDetail/'.$value['sId']);?>" title="查看"><i class="icon-eye-open"></i></a>&nbsp;&nbsp;
                    <?php if($value['flow'][0]['isOver'] == 0){?>
                    <a href="<?php echo site_url('/media/FilmController/filmEdit/'.$value['sId']); ?>" title="修改"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
	                <a href="javascript:deleteConFirm('<?php echo site_url('media/FilmController/filmDel/'.$value['sId']); ?>')" title="删除"><i class="icon-trash"></i></a>
	                <?php } ?>
                </td>
            </tr>
                <?php endforeach;?>
