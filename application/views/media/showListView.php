...
<form method="post" action="" >
    <thead>
        <tr>
          ...
          <th>&nbsp;<a href="<?php echo site_url("media/ShowController/showAdd")?>">新增信息</a></th>
        </tr>
    </thead>
</form>
</table>
    ...
    <table class="table table-condensed">
        ...
        <tbody>
            ...
            <tr class="rowlink">
                ...
                <td>
                    <a href="<?php echo site_url('/media/ShowController/showDetail/'.$value['sId']);?>" title="查看"><i class="icon-eye-open"></i></a>&nbsp;&nbsp;
                    <?php if($value['flow'][0]['isOver'] == 0){?>
                    <a href="<?php echo site_url('/media/ShowController/showEdit/'.$value['sId']); ?>" title="修改"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
	                <a href="javascript:deleteConFirm('<?php echo site_url('media/ShowController/showDel/'.$value['sId']); ?>')" title="删除"><i class="icon-trash"></i></a>
	                <?php } ?>
                </td>
            </tr>
                <?php endforeach;?>
