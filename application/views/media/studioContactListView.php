...
<table data-provides="rowlink" style="margin-bottom:8px;">
    ...
    <thead>
        <tr>
            <th valign="top">
                影城名称：<input type="text" name="name" id="name" style="width:100px;" value="<?php if(!empty($name)) echo $name;?>">
            </th>
            <th valign="top">
                联系人姓名：<input type="text" name="userName" id="userName" value="<?php if(!empty($userName)) echo $userName;?>" style="width:100px;">
            </th>
        ...
        <tbody>
            ...
            <tr class="rowlink">
                ...
                <td>
                    ...
                    <a href="javascript:deleteConFirm('<?php echo site_url('/media/StudioContactController/studioContactDel/'.$value['id']); ?>')" title="删除"><i class="icon-trash"></i></a>
                    <a href="<?php echo site_url("/media/StudioContactController/studioContactEditView/$value[id]")?>" class="sepV_a" title="修改"><i class="icon-pencil"></i></a>
                   <?php endif;?>
                   <a href="<?php echo site_url("/media/StudioContactController/studioDetail/$value[id]")?>" class="sepV_a" title="查看"><i class="icon-eye-open"></i></a>
                </td>
            </tr>
                <?php } }else{ ?>
