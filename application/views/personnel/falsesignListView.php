    ...
    <form method="post" action="" >
        <thead>
            <tr>
                ...
                <th><a href="<?php echo site_url('/personnel/FalsesignController/falsesignAddView/'); ?>"><b>新建表单</b></a>&nbsp;&nbsp;</th>
                <!--<th><a href="<?php echo site_url('/personnel/AublicController/getFalsesign/'); ?>" style="color:red;"><b>误打卡单数据更新</b></a>&nbsp;&nbsp;</th>-->
            </tr>
        </thead>
    </form>
</table>
    ...
    <table class="table table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo date("Y-m-d",$value['startDate']);?>&nbsp;/&nbsp;<?php if($value['type'] != '4'):?><?php echo $falsesignType[$value['type']];?><?php else:?>中午<?php endif;?></td>
                <td><?php echo $value['num'];?>次</td>
                ...
                <td><?php if($value['flow'][0]['isOver'] == 0):?>
                    <a href="<?php echo site_url('/personnel/FalsesignController/falsesignEditView/'.$value['fId']); ?>" title="修改"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
                    <?php else:?>
                    <?php if(in_array('allFalsesign',$userOpera)):?><a href="<?php echo site_url('/personnel/FalsesignController/falsesignEditView/'.$value['fId']); ?>" title="修改"><i class="icon-pencil"></i></a><?php endif;?>&nbsp;&nbsp;
                    <?php endif;?>
                    <a href="<?php echo site_url('/personnel/FalsesignController/falsesignLookView/'.$value['fId']);?>" title="查看"><i class="icon-eye-open"></i></a>&nbsp;&nbsp;
                    <?php if($value['flow'][0]['isOver'] == 0):?>
                    <a href="javascript:deleteConFirm('<?php echo site_url('/personnel/FalsesignController/falsesignUdelView/'.$value['fId']); ?>')" title="删除"><i class="icon-trash"></i></a> &nbsp;&nbsp;
                    <?php else:?>
                    <?php if(in_array('allFalsesign',$userOpera)):?><a href="javascript:deleteConFirm('<?php echo site_url('/personnel/FalsesignController/falsesignUdelView/'.$value['fId']); ?>')" title="删除"><i class="icon-trash"></i></a><?php endif;?> &nbsp;&nbsp;
                    <?php endif;?>
                </td>
            </tr>
            <?php endforeach;?>
