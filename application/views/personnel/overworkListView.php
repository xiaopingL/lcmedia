    ...
    <form method="post" action="" >
        <thead>
            <tr>
                ...
                <th><a href="<?php echo site_url('/personnel/OverworkController/overworkAddView/'); ?>"><b>新建表单</b></a>&nbsp;&nbsp;</th>
            </tr>
        </thead>
    </form>
</table>
    ...
    <table class="table table-condensed">
        <thead>
            <tr>
                ...
                <th>姓名</th>
                <th>填写时间</th>
                <th width="100px;">加班地点</th>
                <th width="60px">开始时间</th>
                <th width="60px">结束时间</th>
                <th width="150px;">工作内容</th>
                <th>合计天数</th>
                <th>审批详情</th>
                <th>状态</th>
                <th>操作</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $value['allDay'];?>天<?php echo $value['allHour'];?>小时</td>
                ...
                <td><?php if($value['flow'][0]['isOver'] == 0):?>
                    <a href="<?php echo site_url('/personnel/OverworkController/overworkEditView/'.$value['oId']); ?>" title="修改"><i class="icon-pencil"></i></a>&nbsp;&nbsp;
                     <?php else:?>
                    <?php if(in_array('allOverTime',$userOpera)):?><a href="<?php echo site_url('/personnel/OverworkController/overworkEditView/'.$value['oId']); ?>" title="修改"><i class="icon-pencil"></i></a><?php endif;?>&nbsp;&nbsp;
                    <?php endif;?>
                    <a href="<?php echo site_url('/personnel/OverworkController/overworkLookView/'.$value['oId']);?>" title="查看"><i class="icon-eye-open"></i></a>&nbsp;&nbsp;
                    <?php if($value['flow'][0]['isOver'] == 0):?>
                    <a href="javascript:deleteConFirm('<?php echo site_url('/personnel/OverworkController/overworkUdelView/'.$value['oId']); ?>')" title="删除"><i class="icon-trash"></i></a> &nbsp;&nbsp;
                    <?php else:?>
                    <?php if(in_array('allOverTime',$userOpera)):?><a href="javascript:deleteConFirm('<?php echo site_url('/personnel/OverworkController/overworkUdelView/'.$value['oId']); ?>')" title="删除"><i class="icon-trash"></i></a><?php endif;?> &nbsp;&nbsp;
                    <?php endif;?>
                </td>
            </tr>
            <?php endforeach;?>
