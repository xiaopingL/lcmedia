...
<form class="form_validation_ttip" action="" method="post">
      <table id="smpl_tbl" class="table table-bordered table-striped">
            <tbody>
                 <tr>
                     <td width="15%">流程名称</td>
                     <td><input type="text" name="processName" class="input-xlarge" value="" /></td>
                 </tr>
                 <tr>
                     <td>流程级数</td>
                     ...
                     <td><table id="tbl_info" cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#bdebff">
                         <tr>
                             <td colspan="3"><b>节点位置</b>：<select name="position" id="position" class="span2">
                                                    ...
                                                    <option value="0">第一级审批前</option>
                                                    <option value="1">第二级审批前</option>
                                                    <option value="2">第三级审批前</option>
                                                    <option value="3">第四级审批前</option>
                                                    <option value="4">第五级审批前</option>
                                                    <option value="5">第六级审批前</option>
                                                    <option value="6">第七级审批前</option>
                                                    <option value="7">第八级审批前</option>
                                                    </select></td>
                        </tr>
			            <tr>
			            ...
			            <tr>
			                <td align="center"><input type="text" name="approve[]" size="10" class="span2"></td>
			                <td align="center"><select name="orgId[]" class="span2">
			                         <option value="">--请选择--</option>
			                         <?php foreach($orgs as $value){ ?>
                                     <option value="<?php echo $value['sId']; ?>" style="<?php if($value['level']==1){echo 'font-weight:bold;color:black;';} ?>">
                                     <?php
			                ...
			                <td align="center"><input type="text" name="limits[]" size="10" class="span1"></td>
		               </tr></table></td>
                 </tr>
                 <tr>
                     ...
                     <td><table cellpadding="4" cellspacing="0" width="100%" border="1" bordercolor="#bdebff">
                         <tr>
                             <td colspan="3"><b>发起人岗位级别</b>：<select name="jobId" id="jobId" class="span2">
                                                    <option value="">--请选择--</option>
                                                    <option value="5">员工或主管</option>
                                                    <option value="3">经理或总监</option>
                         ...
                         <tr>
                             <td colspan="3"><b>申请单条件数量</b>：<select name="numType" id="numType" class="span2">
                                                    <option value="">--请选择--</option>
                                                    <option value="4">条件数量四</option>
                                                    <option value="3">条件数量三</option>
                                                    <option value="2">条件数量二</option>
                                                    <option value="1">条件数量一</option>
                                                    </select></td>
                        </tr>
                        </table></td>
                 </tr>
			     <tr>
			          ...
			          <button class="btn btn-gebo" type="submit" name="submitCreate" value="添加">添加流程</button>&nbsp;
