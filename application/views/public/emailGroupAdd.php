    ...
    <table width="100%" height="100%" border="0" bordercolor="#bdebff" cellSpacing=0 cellPadding=0>
        ...
        <td>
            <table width="100%" height="100%">
                ...
                <tr>
                    <td>
                        <form action="<?php echo site_url('/public/EmailController/emailGroupInsert');?>" method="post" enctype="multipart/form-data" id="mainform" name="mainform" class="form_validation_ttip" novalidate="novalidate" onSubmit="return checkInfo();">
                        <table width="98%" height="100%" border="1" bordercolor="#bdebff" cellSpacing=0 cellPadding=0 style="margin-left:8px;">
                            ...
                            <tr valign="middle">
                               ...
                               <td height="35px;" style="padding-left:5px;">
                                   <input type="text" name="title_email" id="title_email" style="width: 300px;" />
                               </td>
                           </tr>
                            <tr valign="middle">
