...
<form method="post" action="" >
    <thead>
        <tr>
            ...
            <th><a href="<?php echo site_url("public/JournalController/journalAddView")?>">新建日志</a></th>
        </tr>
    </thead>
</form>
</table>
        ...
        <tbody>
           <?php if(!empty($result)){ foreach($result as $value){ ?>
            <tr class="rowlink">
                ...
                <td><a href="<?php echo site_url("/public/JournalController/journalDetailView/".$value['pId'])?>" class="sepV_a" title="详情"><?php echo $value['journalTitle']; ?></a></td>
                ...
                <td>
                    <?php if($this->session->userdata('uId')==$value['operator'] && $value['score'] == ''):?><a href="<?php echo site_url("/public/JournalController/journalEditView/".$value['pId'])?>" class="sepV_a" title="修改"><i class="icon-pencil"></i></a><?php endif; ?>
                    <a href="<?php echo site_url("/public/JournalController/journalDetailView/".$value['pId'])?>" class="sepV_a" title="查看"><i class="icon-eye-open"></i></a>
                    <?php if($this->session->userdata('uId')==$value['operator'] && $value['score'] == ''):?><a href="javascript:deleteConFirm('<?php echo site_url("/public/JournalController/journalDel/".$value['pId']); ?>')" class="sepV_a" title="删除"><i class="icon-trash"></i></a><?php endif; ?>
                </td>
            </tr>
            <?php }}else{ ?>
